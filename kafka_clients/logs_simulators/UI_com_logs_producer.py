...
def generate_random_data_entry():
    data_options = [
        ("101", "Unsigned Short Int", random.randint(0, 10000)),
        ("102", "Double", random.randint(-10, 60000)),
        ("103", "Unsigned Short Int", random.randint(0, 20000)),
        ("132608", "Short Int", random.randint(0, 1)),
        ("132616", "Short Int", random.randint(0, 1)),
        ("132617", "Short Int", random.randint(0, 1)),
        ("132672", "Short Int", random.randint(0, 1))
    ]
