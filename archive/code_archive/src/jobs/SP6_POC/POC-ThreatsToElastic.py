...
KAFKA_BOOTSTRAP_SERVERS = "b-2-public.kafkapublic3.pnoeh5.c3.kafka.eu-central-1.amazonaws.com:9198,b-1-public.kafkapublic3.pnoeh5.c3.kafka.eu-central-1.amazonaws.com:9198"
KAFKA_TOPIC = "threats-topic"
ELASTICSEARCH_SECURITY_EVENTS_INDEX = "ui_threat_events"
ELASTICSEARCH_SEVS_LOGS_INDEX = "ui_threat_logs"
ELASTICSEARCH_BATCH_LOGS_INDEX = "logging_threats"
...
def main():
    ...
    spark = SparkSession.builder \
        ...
        .config("spark.sql.streaming.checkpointLocation", "s3://aws-emr-studio-381492251123-eu-central-1/stream_checkpoint/checkpoint/threats_poc/") \
        .getOrCreate()
    ...
    query = kafka_df.writeStream \
        ...
        .option("checkpointLocation", "s3://aws-emr-studio-381492251123-eu-central-1/stream_checkpoint/checkpoint/threats_poc/") \
