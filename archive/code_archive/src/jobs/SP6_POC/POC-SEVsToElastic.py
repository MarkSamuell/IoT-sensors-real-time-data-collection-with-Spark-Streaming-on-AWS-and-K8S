...
def main():
    ...
    spark = SparkSession.builder \
        ...
        .config("spark.sql.streaming.checkpointLocation", "s3://aws-emr-studio-381492251123-eu-central-1/stream_checkpoint/checkpoint/sevs_poc/") \
        .getOrCreate()
    ...
    query = kafka_df.writeStream \
        ...
        .option("checkpointLocation", "s3://aws-emr-studio-381492251123-eu-central-1/stream_checkpoint/checkpoint/sevs_poc/") \
